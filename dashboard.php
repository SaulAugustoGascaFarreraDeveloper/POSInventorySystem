...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Saul Gasca</span>
            </a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Saul Gasca</a>
        </div>
      </div>
  ...
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline">
      Test Development V-1.0
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2023 <a href="https://github.com/SaulAugustoGascaFarreraDeveloper?tab=repositories">Saul Augusto Gasca Farrera</a>.</strong> sgfarreradev@gmail.com
  </footer>
</div>
<!-- ./wrapper -->
